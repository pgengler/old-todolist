...
sub statement()
{
	...
	my $statement = new Database::Statement($self, $sql, 'error' => $self->{'error'});
...
## QUOTE IDENTIFIER
#######
## Proxy for underlying DBH's 'quote_identifier' method.
#######
sub quote_identifier
{
	...
	return $self->{'_dbh'}->quote_identifier($identifier);
}
